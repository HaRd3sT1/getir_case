        ...
        <div id="vorkasse" className={classnames(styles.Vorkasse)}>
            <div className={classnames(styles.content)}>
                ...
                <div className={classnames(styles.main)} id="divcontents">
                    ...
                    <p>Bitte Überweisen Sie den angezeigtten Betarg an die unten angegebene Bankverbindung und gib dabei als Verwendungszweck deinen Nickname und die angezeingte Nummer an! Das ist sehr wichtig andern falls können wir die Zahlung nicht zuordnen. </p>
                    <ul>
                        <li>
                            <span>Bank: </span> VR Bank Nord eG
                        </li>
                        <li>
